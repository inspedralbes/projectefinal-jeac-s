...
export class Game extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.image('background', './ImageGames/BallGameImg/background.png');
      this.load.image('gameover', './ImageGames/BallGameImg/gameover.png');
      this.load.image('platform', './ImageGames/BallGameImg/platform.png');
      this.load.image('ball', './ImageGames/BallGameImg/ball.png');
      this.load.image('bluebrick', './ImageGames/BallGameImg/brickBlue.png');
      this.load.image('blackbrick', './ImageGames/BallGameImg/brickBlack.png');
      this.load.image('greenbrick', './ImageGames/BallGameImg/brickGreen.png');
      this.load.image('orangebrick', './ImageGames/BallGameImg/brickOrange.png');
      this.load.image('greybrick', './ImageGames/BallGameImg/brickGrey.png');
      this.load.image('whitebrick', './ImageGames/BallGameImg/brickWhite.png');
      this.load.image('yellowbrick', './ImageGames/BallGameImg/brickYellow.png');

      this.load.spritesheet('bluediamond',
      './ImageGames/BallGameImg/blue_diamond-sprites.png',
      { frameWidth: 48, frameHeight: 48 }
    );
    this.load.spritesheet('reddiamond',
      './ImageGames/BallGameImg/red_diamond-sprites.png',
      { frameWidth: 48, frameHeight: 48 }
    );
    this.load.spritesheet('greendiamond',
      './ImageGames/BallGameImg/green_diamond-sprites.png',
      { frameWidth: 48, frameHeight: 48 }
    );
