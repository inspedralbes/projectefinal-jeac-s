                        ...
                        >
                            ...
                            <Dropdown.Item onClick={() => changeLanguage('cat')}>
                                <div className="flex m-auto mb-2">
                                    ...
                                    <img className="w-5 ml-2 md:w-7 lg:w-10 cursor-pointer" src="catalan.png" alt="Español" />&nbsp;&nbsp;&nbsp;
                                </div>
                            </Dropdown.Item>
                            ...
                            <Dropdown.Item onClick={() => changeLanguage('en')}>
                                <div className="flex m-auto mb-2">
                                    ...
                                    <img className="w-5 ml-2 md:w-7 lg:w-10 cursor-pointer" src="ingles.png" alt="Español" />&nbsp;&nbsp;&nbsp;
                                </div>
                            </Dropdown.Item>
                        </Dropdown>
                    </div>
