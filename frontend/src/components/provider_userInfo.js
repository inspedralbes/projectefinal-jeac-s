            ...
            <div className="p-4">
              <div className="md:m-6 md:p-12">
                <div className="text-center text-white">
                  <nav className="backdrop-filter backdrop-blur-l bg-opacity-30 border-b-4 border-fuchsia-600">
                    <div className="flex space-x-4">

                      <li className={`w-1/4 list-none ${activeTab === "tab1" ? "active" : ""}`}>
                        <a onClick={() => handleTabClick("tab1")} className="text-gray-300 text-xl hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 font-medium">
                          {t('profileUserInfo')}
                        </a>
                      </li>

                      <li className={`w-1/4 list-none ${activeTab === "tab2" ? "active" : ""}`}>
                        <a onClick={() => handleTabClick("tab2")} className="text-gray-300 text-xl hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 font-medium">
                          {t('profileHistorial')}
                        </a>
                      </li>

                      <li className={`w-1/4 list-none ${activeTab === "tab3" ? "active" : ""}`}>
                        <a onClick={() => handleTabClick("tab3")} className="text-gray-300 text-xl hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 font-medium">
                          {t('profileColeccionables')}
                        </a>
                      </li>

                      <li className={`w-1/4 list-none ${activeTab === "tab4" ? "active" : ""}`}>
                        <a onClick={() => handleTabClick("tab4")} className="text-gray-300 text-xl hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                          {t('profileLogros')}
                        </a>
                      </li>
                  ...
                  {activeTab === "tab1" &&
                    <div>
                      ...
                      <table className="table-auto">
                        ...
                        <tbody>
                          <tr>
                            <td><img className="rounded-full w-full border-4 border-fuchsia-600" src={avatar()} alt=""></img></td>
                            <td><h4>{userInfo.name}</h4></td>
                            <td><h4>{userInfo.email}</h4></td>
                            <td><h4>{userInfo.totalScore}</h4></td>
                            <td><h4>{userInfo.jeacstars}<img className="w-10 h-10 inline" src="JeacstarNF.png"></img></h4></td>
                          </tr>
                        </tbody>
                      </table>
