  ...
  return (
    <div className="overflow-auto bg-image-all bg-cover bg-no-repeat bg-center bg-fixed flex h-screen justify-center items-center ">
      {isLoggedIn ?
                ...
                <div className="text-center text-white">
                  <nav className="backdrop-filter backdrop-blur-l bg-opacity-30 border-b-4 border-fuchsia-600 p-4">
                    <div className="flex space-x-4">
                      <li classNameName={`w-1/4 list-none`}>
                        <a onClick={() => handleTabClick("tab1")} classNameName={`mt-4 mb-4 text-gray-300 text-xl hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 font-medium cursor-pointer p-4 ${activeTab === "tab1" ? "active bg-gray-700" : ""}`}>
                          {t('profileUserInfo')}
                        </a>
                      </li>

                      <li classNameName={`w-1/4 list-none`}>
                        <a onClick={() => handleTabClick("tab2")} classNameName={`text-gray-300 text-xl hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 font-medium cursor-pointer ${activeTab === "tab2" ? "active bg-gray-700" : ""}`}>
                          {t('profileHistorial')}
                        </a>
                      </li>

                      <li classNameName={`w-1/4 list-none`}>
                        <a onClick={() => handleTabClick("tab3")} classNameName={`text-gray-300 text-xl hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 font-medium cursor-pointer ${activeTab === "tab3" ? "active bg-gray-700" : ""}`}>
                          {t('profileColeccionables')}
                        </a>
                      </li>

                      <li classNameName={`w-1/4 list-none`}>
                        <a onClick={() => handleTabClick("tab4")} classNameName={`text-gray-300 text-xl hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium cursor-pointer ${activeTab === "tab4" ? "active bg-gray-700" : ""}`}>
                          Tus Juegos
                        </a>
                      </li>
                    </div>
                      ...
                      <form onSubmit={changeName}>
                        <div className="border-2 border-fuchsia-600 relative mb-4 mt-10" data-te-input-wrapper-init>
                          <label
                            ...
                            className="text-gray-400 pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-white transition-all duration-200 ease-out peer-focus:-translate-y-[2rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary">
                            {t('profileChangeName')}
                          </label>
                          <br></br>
                          <input
                  ...
                  <div>
                    {activeTab === "tab3" &&
                      <div classNameName="mb-3 mt-md-4">
                        {isLoading ?
                        ...
                        <table className="table-flex flex-1 w-full ">
                          ...
                          <tbody>
                            {uploadedGames.map((game) => (
                              <tr key={game.id} classNameName="h-20 odd:bg-gray-700">
                                <td>{game.name}</td>
        ...
        :
        <div>
          <div className="p-10 opacity-90 text-center bg-purple-300 rounded-lg">
            <p className="mb-6 text-lg font-normal text-fuchsia-950 lg:text-2xl sm:px-16 xl:px-48 dark:text-gray-400">
            ...
            <NavLink to="/login">
              <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-white bg-emerald-700 rounded-lg hover:bg-violet-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                {t('logIn')}
              </a>
            </NavLink>
            <a> </a>
