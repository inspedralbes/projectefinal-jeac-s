        ...
        <div class="overflow-auto bg-image-all bg-cover bg-no-repeat bg-center bg-fixed flex h-screen justify-center items-center ">
            <div class="container h-full w-3/4 p-10">
                <div class="block rounded-lg bg-gray-800 shadow-lg dark:bg-neutral-800">
                    <div class="p-4">
                        <h2 class="font-mono text-white text-center  text-4xl mt-10 font-bold">GUIA CREACION DE JUEGO</h2>
                        <div class="md:m-6 md:p-12">
                            <div class="text-white text-xl">
                                ...
                                <h1 class="text-3xl font-bold text-center ">configGame</h1><br></br>
                                ...
                                <img src="imageN1.png" class = "mx-auto border-2 rounded border-fuchsia-500"></img>
                                <br></br>

                                <p>Dentro de la variable tienes que definir:</p><br></br>

                                <p class = "text-center">-Si el juego es de un solo jugador, puede ser true o false</p><br></br>

                                <p class = "text-center">-Si el juego tiene multijugador, puede ser true o false</p><br></br>

                                <p class = "text-center">-El número de jugadores máximos que se pueden unir</p><br></br>
                                ...
                                <h1 class="text-3xl font-bold text-center ">Función init</h1><br></br>

                                <img src="imageN2.png" class = "mx-auto border-2 rounded border-fuchsia-500"></img><br></br>
                                ...
                                <h1 class="text-3xl font-bold text-center ">Función preload</h1><br></br>
                                ...
                                <p class = "italic">./fitxers/GamesFiles/nombreDelJuego/rutaImagenes</p><br></br>
                                
                                <p>Por ejemplo:</p><br></br>

                                <img src="imageN3.png" class = "mx-auto border-2 rounded border-fuchsia-500"></img><br></br><br></br>

                                <h1 class="text-3xl font-bold text-center ">Función sendInfoGame</h1><br></br>
                                ...
                                <img src="imageN4.png" class = "mx-auto border-2 rounded border-fuchsia-500"></img><br></br>
                                ...
                                <h1 class="text-3xl font-bold text-center ">Función recibirInfoFromPlatform</h1><br></br>
                                ...
                                <h1 class="text-3xl font-bold text-center ">Función recibirInfoLobby</h1><br></br>
                                ...
                                <img src="imageN5.png" class = "mx-auto border-2 rounded border-fuchsia-500"></img><br></br><br></br>

                                <h1 class="text-3xl font-bold text-center ">Función userLeft</h1><br></br>
                                ...
                                <img src="imageN6.png" class = "mx-auto border-2 rounded border-fuchsia-500"></img><br></br><br></br>

                                <h1 class="text-3xl font-bold text-center ">Función destroyGame</h1><br></br>
                                ...
                                <img src="imageN7.png" class = "mx-auto border-2 rounded border-fuchsia-500"></img><br></br><br></br>

                                <h1 class="text-3xl font-bold text-center ">Función finalJuego</h1><br></br>
                                ...
                                <img src="imageN8.png" class = "mx-auto border-2 rounded border-fuchsia-500"></img><br></br>
                                ...
                                <img src="imageN9.png" class = "mx-auto border-2 rounded border-fuchsia-500"></img><br></br>
